...
accelerate launch   --mixed_precision bf16  --dynamo_backend 'no' --num_processes $num_process  run_main.py \
  ...
  --hgcn_true False \
  --hgat_true True \
  >>./result/PEMS03_hypergnn/Deepseek2b_PEMS03_48_48.txt
...
accelerate launch   --mixed_precision bf16  --dynamo_backend 'no' --num_processes $num_process  run_main.py \
  ...
  --gcn_true True \
  --hgcn_true True \
  >>./result/PEMS03_hypergnn/Deepseek2b_PEMS03_48_48_mix_order3.txt
...
accelerate launch   --mixed_precision bf16  --dynamo_backend 'no' --num_processes $num_process  run_main.py \
  ...
  --hgcn_true True \
  --hgat_true True \
  >>./result/PEMS03_hypergnn/Deepseek2b_PEMS03_48_48_hypergnn_naive_order3.txt
